...
enum ScriptureCatalog {
    ...
    static let diamondSutra: Scripture = loadScriptureResource(named: "diamond-sutra") ?? scriptureStub(id: "diamond-sutra", title: "金刚般若波罗蜜经", shortTitle: "金刚经", translator: "鸠摩罗什", dynasty: "姚秦", category: "般若", durationMinutes: 45, hasAudio: false)
